            ...
            <div class="panel-heading">Manage Authors</div>
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        <h4>Select the Author you want to Update</h4>
			<label>Select Existing Author</label>
...
?>
	...
	<label>Enter New Author</label>
			<input type="text" class="form-control" name="e1" placeholder="Enter New Author" required><br>
			<button type="submit" class="btn btn-success" name="update_cat">Update Author</button>
		</form><br><br>
<?php endif; ?>
		 <div class="table-responsive">
		<form action="manage_authors.php" method="POST">
...
<?php
	if(isset($_POST['update_cat'])){
		...
		$sql = "UPDATE author SET author_name='$e1' WHERE id='$exists'";

		if (mysqli_query($conn, $sql)) {
			echo "<script>alert('Author Updated successfully');window.location.href='manage_authors.php';</script>";
		} else {
...
<?php
	if(isset($_POST['delete'])){
		...
		$sql = "DELETE FROM author WHERE id='".$_POST['delete']."'";

		if (mysqli_query($conn, $sql)) {
			echo "<script>alert('Author Deleted');window.location.href='manage_authors.php';</script>";
		} else {
